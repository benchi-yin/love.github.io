$(document).ready(function() {
   ...
   // $('.navigation').append('<area shape="poly" coords="10,10, 200,200, 145,254, 73,294, 0,10, 0,10" href="#!/page_About" alt="" class="nav2">')
    ...
    $('.map_logo').append('<area shape="poly" coords="115,-7, 230,45, 200,45, 115,257, 0,190, 0,60" href="#close" alt="Jammy�s Folio ui designer &amp; developer" class="logo">')
